...
export class ElementsService {
  ...
  filterAtomicNumber(numberAtomic: number): any {
    this.elements = this.getAllElements();
    this.element = this.elements.filter(
      (item: any) => item.atomicNumber === numberAtomic
    );
    return this.element;
  }
  ...
  filterGroupBlock(groupBlock: string): any {
    this.elements = this.getAllElements();
    this.element = this.elements.filter(
      (item: any) => item.groupBlock === groupBlock
    );
    return this.element;
  }
  ...
  filterProcediment(itemSupport: string): any {
    ...
    this.arrayProcess = this.procediments.filter(
      (item: any) => item.falla === itemSupport
    );
